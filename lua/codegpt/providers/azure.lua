...
local function is_legacy()
	...
	-- We should check if `chat_completions_url` is match
	-- `/deployments/{deployment-id}/chat/completions`
	-- If not, should use the legacy parameters
	local completions_url = Config.opts.connection.chat_completions_url
...
function M.get_models()
	vim.notify("azure: not implemented", vim.log.levels.WARN)
end
